...
public class PartsStrip {
    ...
    static boolean stripPropertiesParts = false;
    static boolean keepStyles = true;
    static boolean defaultToDelete = false;

    static boolean stripOleObjects = true;
        ...
        for (Relationship r : rp.getRelationships().getRelationship()) {
            ...
            try {
                ...
                if (part == null) {
                    ...
                    deletions.add(r);
                    sb.append(".. DELETED");
                } else if (part instanceof org.docx4j.openpackaging.parts.WordprocessingML.OleObjectBinaryPart) {
